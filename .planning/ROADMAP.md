...
**Plans**: 8 plans (gap-closure 02-04 inserted 2026-05-04 after first prod deploy surfaced parser format mismatch)

- [x] 02-01-PLAN.md - WeasyPrint GTK3 spike Windows Server + PdfExporter ABC + ReportLab fallback (DEP-06)
...
- [x] 02-07-PLAN.md - Alembic 0002 group activation + cross-user authz + family share endpoint + 40-test authz matrix + SharedBadge + ShareToggleMenu (FAM-01..09; 0002 corrected from 0001 due to Plan 02-04 chain head 8137b2e24001)
- [~] 02-08-PLAN.md - Phase 2 closure CHECKPOINT: autonomous portion done (VERIFICATION.md + family-convergence e2e green in 4.8s + axe-core 8/8 covering /today + /settimana + /spesa + visual baselines 12/12 + tone review + iPhone PDF + GTK3 Day 7 checklists scaffolded). PENDING CHECKPOINT — awaits Stefano + Marta tone review sign-off + Stefano iPhone PDF accent verify + Stefano GTK3 Day 7 verdict + Stefano production Lighthouse measurement. See `.planning/phases/02-differentiators/VERIFICATION.md` §6.
